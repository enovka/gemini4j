...
public class HttpClientTest {
    ...
    public void testGetRequestWithHeaders() throws HttpException {
        ...
        System.out.println("Stubbing GET request on URL: " + wireMockServer.baseUrl() + "/test");
        ...
        HttpResponse response = httpClient.get(wireMockServer.baseUrl() + "/test", headers);
    ...
    public void testPostRequestWithHeadersAndBody() throws HttpException {
        ...
        System.out.println("Stubbing POST request on URL: " + wireMockServer.baseUrl() + "/test");
        ...
        HttpResponse response = httpClient.post(wireMockServer.baseUrl() + "/test", requestBody, headers);
    ...
    public void testHttpClientError() {
        ...
        System.out.println("Stubbing GET request on URL: " + wireMockServer.baseUrl() + "/test");
        stubFor(get(urlEqualTo("/test")).willReturn(aResponse().withStatus(404)));
        ...
        HttpException exception = assertThrows(HttpException.class,
                () -> httpClient.get(wireMockServer.baseUrl() + "/test", new HashMap<>()));
        System.out.println("HttpException caught.");

        // Assertions about the exception
        System.out.println("Exception status code: " + exception.getStatusCode());
    ...
    public void testHttpServerError() {
        ...
        System.out.println("WireMock isHttpEnabled()? : " + wireMockServer.isRunning());

        // Stub a GET request that returns a 500 Internal Server Error
        System.out.println("Stubbing GET request on URL: " + wireMockServer.baseUrl() + "/test");
        stubFor(get(urlEqualTo("/test")).willReturn(aResponse().withStatus(500)));
