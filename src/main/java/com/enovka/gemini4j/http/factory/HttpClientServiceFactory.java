 ...
 * @since 1.0.0-beta
 */
public class HttpClientServiceFactory extends BaseClass {

    private static final String ERROR_MESSAGE_INVALID_CLIENT_TYPE
            = "Invalid client type provided.";

    /**
     * Creates a new HttpClientService instance based on the specified client
     * type.
     *
    ...
    public static HttpClientService create(ClientType clientType) {
        ...
        default:
            throw new IllegalArgumentException(
                    ERROR_MESSAGE_INVALID_CLIENT_TYPE);
        }
    }

    /**
     * Creates a new HttpClientService instance based on the specified client
     * type and custom validator.
     *
     * @param clientType The type of HTTP client to create.
    ...
    /**
     * Creates a new HttpClientService instance based on the specified client
     * type, custom client, and custom validator.
     *
     * @param clientType The type of HTTP client to create.
     * @param httpClient The custom HttpClient instance to use.
     * @param httpResponseWrapper The custom HttpResponseWrapper instance to
     * use.
     * @param validator The custom validator to use.
     * @return A new HttpClientService instance.
     * @throws IllegalArgumentException If an invalid client type is provided.
    ...
    public static HttpClientService create(ClientType clientType,
        ...
        switch (clientType) {
        case DEFAULT:
            return new DefaultHttpClientService((HttpClient) httpClient,
                    validator);
        case CUSTOM:
            return new CustomHttpClientService((HttpClientService) httpClient,
                    httpResponseWrapper, validator);
        default:
            throw new IllegalArgumentException(
                    ERROR_MESSAGE_INVALID_CLIENT_TYPE);
        }
