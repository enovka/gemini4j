...
public class Tool {
   ...
   * [FunctionCall][content.part.function_call] with arguments to the client
   * side for execution. The model may decide to call a subset of these
   * functions by populating [FunctionCall][content.part.function_call] in the
   * response. The next conversation turn may contain a
