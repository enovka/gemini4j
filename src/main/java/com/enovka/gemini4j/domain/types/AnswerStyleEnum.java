...
public enum AnswerStyleEnum {
  ...
  /**
   * Generate a very brief and extractive answer, directly quoting from the source material.
   */
  @JsonProperty("EXTRACTIVE")
  EXTRACTIVE,

  /**
   * Generate a verbose answer, including extra details and context. The response may be formatted as a sentence, paragraph, multiple paragraphs, or bullet points.
   */
