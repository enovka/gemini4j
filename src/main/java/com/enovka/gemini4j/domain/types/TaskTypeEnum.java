...
public enum TaskTypeEnum {
  ...
  /**
   * The task type is unspecified. This value will default to one of the other enum values.
   */
  @JsonProperty("TASK_TYPE_UNSPECIFIED")
  TASK_TYPE_UNSPECIFIED,

  /**
   * The embedding will be used for a retrieval query. The given text represents a search query.
   */
  @JsonProperty("RETRIEVAL_QUERY")
  RETRIEVAL_QUERY,

  /**
   * The embedding will be used for a retrieval document. The given text represents a document within the search corpus.
   */
  ...
  /**
   * The embedding will be used for classification tasks. The given text will be classified into one or more categories.
   */
