 ...
 * harm category.
 * <p>
 * The classification system assigns a probability to each piece of content for
 * each harm category, indicating the likelihood of the content being harmful.
 * This does not reflect the severity of the potential harm, only its
 * probability.
 *
