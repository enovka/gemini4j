...
public class GenerateAnswerResponse {
   ...
   * <p>
   * Note: The model always attempts to provide a grounded answer, even when the
   * answer is unlikely to be answerable from the given passages. In that case, a
   ...
   * <p>
   * A low answerableProbability indicates that the answer might not be grounded
   * in the sources.
   * <p>
